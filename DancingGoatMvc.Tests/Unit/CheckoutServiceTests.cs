...
namespace DancingGoat.Tests.Unit
{
    ...
    public class CheckoutServiceTests : UnitTests
    {
        ...
        public void SetUp()
        {
            ...
            var shoppingService = Substitute.For<IShoppingService>();
            shoppingService.GetCurrentShoppingCart().Returns(mShoppingCartInfo);
            ...
            checkoutService = new CheckoutService(shoppingService, addressRepository, paymentMethodRepository, shippingOptionRepository, countryRepository);
        }
