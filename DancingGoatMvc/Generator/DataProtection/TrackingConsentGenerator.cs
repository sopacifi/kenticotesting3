...
namespace DancingGoat.Generator
{
    public class TrackingConsentGenerator
    {
        ...
        internal const string DATA_PROTECTION_RESOURCE_STRING_PREFIX = "DancingGoatMvc.DataProtection";
        internal const string CONSENT_NAME = "DancingGoatMVCTracking";
        private const string CONSENT_DISPLAY_NAME = "Dancing Goat MVC - Tracking";
