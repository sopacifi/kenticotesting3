...
namespace DancingGoat.Generator
{
    ...
    internal class NewslettersDataGenerator
    {
        ...
        {
            var coffee101Newsletter = NewsletterInfoProvider.GetNewsletterInfo("Coffee101", site.SiteID);
        ...
        {
            var lesson1 = IssueInfoProvider.GetIssues().OnSite(site.SiteID).WhereEquals("IssueSubject", "Coffee 101 - Lesson 1").FirstOrDefault();
            var lesson2 = IssueInfoProvider.GetIssues().OnSite(site.SiteID).WhereEquals("IssueSubject", "Coffee 101 - Lesson 2").FirstOrDefault();
