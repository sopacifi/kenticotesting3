...
namespace DancingGoat.PageTemplatesFilters
{
    /// <summary>
    ...
    public class LandingPageTemplatesFilter : IPageTemplateFilter
    {
        ...
        {
            if (context.PageType.Equals("DancingGoatMvc.LandingPage", StringComparison.InvariantCultureIgnoreCase))
            {
        ...
        /// </summary>
        public IEnumerable<string> GetLandingPageTemplates() => new string[] { "DancingGoat.LandingPageSingleColumn" };
    }
}