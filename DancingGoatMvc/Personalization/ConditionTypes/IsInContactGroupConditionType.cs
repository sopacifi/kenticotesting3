...
[assembly: RegisterPersonalizationConditionType("DancingGoat.Personalization.IsInContactGroup", typeof(IsInContactGroupConditionType), "{$DancingGoatMvc.ConditionType.IsInContactGroup.Name$}", Description = "{$DancingGoatMvc.ConditionType.IsInContactGroup.Description$}", IconClass = "icon-app-contact-groups", Hint = "{$DancingGoatMvc.ConditionType.IsInContactGroup.Hint$}")]
